...
$versubcategoriaspack001phone = mysql_query($query_versubcategoriaspack001phone, $gabrielle) or die(mysql_error());
$row_versubcategoriaspack001phone = mysql_fetch_assoc($versubcategoriaspack001phone);
$totalRows_versubcategoriaspack001phone = mysql_num_rows($versubcategoriaspack001phone);
?>
...
<?php do { ?>
  ...
  <div class="separadoruno"></div>
  <?php } while ($row_versubcategoriaspack001phone = mysql_fetch_assoc($versubcategoriaspack001phone)); ?>
    <?php } // Show if recordset not empty ?>
...
mysql_free_result($versubcategoriaspack001phone);
?>
