...
$varIdCategoria_versubcategoriaspack001phone = "0";
if (isset($_GET ["recordID"])) {
  $varIdCategoria_versubcategoriaspack001phone = $_GET ["recordID"];
}
  mysqli_select_db($gabrielle, $database_gabrielle);
$query_versubcategoriaspack001phone = sprintf("SELECT * FROM tblpack001subcategoria WHERE tblpack001subcategoria.intCategoria = %s", GetSQLValueString($varIdCategoria_versubcategoriaspack001phone, "int"));
$versubcategoriaspack001phone =  mysqli_query($query_versubcategoriaspack001phone, $gabrielle) or die( mysqli_error($gabrielle));
$row_versubcategoriaspack001phone =  mysqli_fetch_assoc($versubcategoriaspack001phone);
$totalRows_versubcategoriaspack001phone =  mysqli_num_rows($versubcategoriaspack001phone);
?>
...
<table width="100%" border="0">
  <tr>
    <td align="center"><img src="../admin3274/anagrama/img/<?php echo $row_anagrama['strImagen']; ?>" width="85%" /></td>
  </tr>
  <tr>
    <td align="center"><?php include("../menues/menu-idioma.php"); ?></td>
  </tr>
  <tr>
    <td align="center"><?php echo $row_textoaweb['strTexto8']; ?><br /><a href="mailto:<?php echo $row_contacto['strEmail']; ?>" title="mándame un email"><?php echo $row_contacto['strEmail']; ?></a> | <?php echo $row_contacto['strTelefono']; ?></td>
  </tr>
</table>
</div>
<!-- InstanceEndEditable -->
...
<td>
<div class="gotico">
<?php echo $row_verpackcategorias01['strDescripcion']; ?>
</div>
</td>
</tr>
</table>
...
<td align="right">
<div class="menuhorizontal0001">
<?php echo $row_textoaweb['strTexto6']; ?> <strong><?php echo $row_verpackcategorias01['strNombre']; ?></strong>&nbsp;&nbsp;
</div>
</td>
</tr>
</table>
...
<div class="botonsub">
<a href="articulo.php?recordID=<?php echo $row_versubcategoriaspack001['idSubCategoria']; ?>" title="ver artículos de la colección  <?php echo $row_versubcategoriaspack001['strNombre']; ?>" 
...
<?php do { ?>
  <table width="95%" align="center" border="0">
    <tr>
      <td><?php echo $row_versubcategoriaspack001phone['strNombre']; ?> </td>
      </tr>
    <tr>
      <td><a href="articulo.php?recordID=<?php echo $row_versubcategoriaspack001phone['idSubCategoria']; ?>" title="ver artículos de la colección  <?php echo $row_versubcategoriaspack001phone['strNombre']; ?>"><img src="../admin3274/pack001/img/subcategoria/<?php echo $row_versubcategoriaspack001phone['strImagen2']; ?>" width="100%" /></a>
        </td>
      </tr>
  </table>
  <div class="separadoruno"></div>
  <?php } while ($row_versubcategoriaspack001phone =  mysqli_fetch_assoc($versubcategoriaspack001phone)); ?>
    <?php } // Show if recordset not empty ?>
...
<td align="right">
<div class="menuhorizontal0002">
<?php echo $row_textoaweb['strTexto4']; ?>&nbsp;&nbsp;
</div>
</td>
</tr>
</table>
...
<?php
 ...
 mysqli_free_result($versubcategoriaspack001phone);
?>
