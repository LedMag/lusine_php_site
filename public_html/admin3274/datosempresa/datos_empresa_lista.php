...
$datos =  mysqli_query($query_datos, $gabrielle) or die( mysqli_error($gabrielle));
...
<strong>DATOS DE EMPRESA</strong><!-- InstanceEndEditable -->
</td>
</tr>
<tr>
  <td colspan="2" align="right" class="tipografiagothic" style="height:1%">
  <!-- InstanceBeginEditable name="subtitulocontenido" -->
<a href="datos_empresa_edit.php?recordID=<?php echo $row_datos['idDatosEmpresa']; ?>">Modificar Datos Empresa</a> <!-- InstanceEndEditable -->
  </td>
</tr>
<!--**************************************************************************************************** -->
<!--**************************************************************************************************** -->
...
<strong>Nombre Empresa:</strong> <?php echo $row_datos['strEmpresa']; ?><br />
<strong>C.I.F:</strong> <?php echo $row_datos['strCif']; ?><br />
<strong>Dirección:</strong> <?php echo $row_datos['strDireccion']; ?><br />
<strong>Población:</strong> <?php echo $row_datos['strPoblacion']; ?> (<?php echo $row_datos['strCodigo']; ?>)<br />
<strong>Provincia:</strong> <?php echo $row_datos['strProvincia']; ?><br />
<strong>País:</strong> <?php echo $row_datos['strPais']; ?><br />
<strong>Dominio Web:</strong> <?php echo $row_datos['strDominio']; ?><br />
<strong>Email:</strong> <?php echo $row_datos['strEmail']; ?><br />
<strong>Teléfono:</strong> <?php echo $row_datos['strTelefono']; ?><br />
</div>
<!-- InstanceEndEditable -->
</td>
</tr>
