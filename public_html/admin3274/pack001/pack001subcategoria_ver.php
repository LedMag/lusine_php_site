...
<!-- InstanceBeginEditable name="titulocontenidoprincipal" -->VER CATEGORÍA <strong><?php echo $row_pack001subcategoria['strNombre']; ?></strong>&nbsp;PACK001 <!-- InstanceEndEditable -->
</td>
</tr>
<tr>
  <td colspan="2" align="right" class="tipografiagothic" style="height:1%">
  <!-- InstanceBeginEditable name="subtitulocontenido" -->
  <a href="pack001subcategoria_lista.php"><strong>Volver</strong> Listado Categorías PACK001</a>
  <!-- InstanceEndEditable -->
  </td>
</tr>
<!--**************************************************************************************************** -->
...
IMAGEN SUBCATEGORÍA
<div class="imagen">
<a href="pack001subcategoria_ver.php?recordID=<?php echo $row_pack001subcategoria['idsubcategoria']; ?>"><img src="img/subcategoria/<?php echo $row_pack001subcategoria['strImagen']; ?>" width="100%" /></a>
</div>
<p>
ICONO SUBCATEGORÍA
<div class="imagen">
  <img src="img/subcategoria/<?php echo $row_pack001subcategoria['strImagen2']; ?>" width="33%" />
</div>



<div class="imagen">
Posición: <?php echo $row_pack001subcategoria['strPosicion']; ?> 
</div>
<p>
<div class="imagen">
<strong>Descripción Portada Breve:</strong><br />
<?php echo $row_pack001subcategoria['strDescripcion']; ?>
</div>
<p>
...
<?php echo $row_pack001subcategoria['strSeo1']; ?>
</div>
<p>

<div class="imagen">
<strong>Descripción S.E.O:</strong><br />
<?php echo $row_pack001subcategoria['strSeo2']; ?>
</div>
...
<P><P>
<div class="tipografiagothicdcha">
<a href="pack001subcategoria_edit.php?recordID=<?php echo $row_pack001subcategoria['idSubCategoria']; ?>">MODIFICAR</a> - <a href="pack001subcategoria_delete.php?recordID=<?php echo $row_pack001subcategoria['idSubCategoria']; ?>">ELIMINAR</a></div>
<!-- InstanceEndEditable -->
</td>
</tr>
<tr>
