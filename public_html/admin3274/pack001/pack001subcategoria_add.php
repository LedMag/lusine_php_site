...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblpack001subcategoria (intCategoria, strImagen, strImagen2, 
  ...
  $insertGoTo = "pack001subcategoria_lista.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
mysql_select_db($database_gabrielle, $gabrielle);
$query_pack001subcategoria = "SELECT * FROM tblpack001subcategoria ORDER BY tblpack001subcategoria.idSubCategoria ASC";
...
AÑADIR SUBCATEGORÍA PACK001<!-- InstanceEndEditable -->
</td>
</tr>
<tr>
  <td colspan="2" align="right" class="tipografiagothic" style="height:1%">
  <!-- InstanceBeginEditable name="subtitulocontenido" -->
  <a href="pack001subcategoria_lista.php"> <strong>Volver</strong> Listado Subcategorias PACK001</a>
  <!-- InstanceEndEditable -->
  </td>
</tr>
<!--**************************************************************************************************** -->
...
do {  
?>
<option value="<?php echo $row_pack001categoria['idCategoria']?>" ><?php echo $row_pack001categoria['strNombre']?></option>
<?php
} while ($row_pack001categoria = mysql_fetch_assoc($pack001categoria));
?>
</select></td>
<!--**************************************************************************************************** --> 
<!--**************************************************************************************************** --> 
