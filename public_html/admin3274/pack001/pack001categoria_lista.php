...
<!-- InstanceBeginEditable name="titulocontenidoprincipal" -->LISTADO CATEGORÍAS PACK001<!-- InstanceEndEditable -->
</td>
</tr>
<tr>
  <td colspan="2" align="right" class="tipografiagothic" style="height:1%">
...
<a href="pack001categoria_add.php"><strong>Añadir</strong> Categoría Principal PACK001</a>
...
<div class="separadorarlineas"></div>
	<?php do { ?>
    <?php if ($row_pack001categoria['strActiva'] == "si") { // Show if recordset not empty ?>
    <div class="tipografiagothic">
    NOMBRE: <strong><a href="pack001categoria_edit.php?recordID=<?php echo $row_pack001categoria['idCategoria']; ?>"><?php echo $row_pack001categoria['strNombre']; ?></a></strong>
    </div>
    <div class="imagen"> <a href="pack001categoria_ver.php?recordID=<?php echo $row_pack001categoria['idCategoria']; ?>"><img src="img/categoria/<?php echo $row_pack001categoria['strImagen']; ?>" width="33%" /></a><br />
	Posición: <strong><?php echo $row_pack001categoria['strPosicion']; ?></strong><br />
    Visualizar: <strong><?php echo $row_pack001categoria['strActiva']; ?></strong><br />

    </div>
<div class="separadorarlineas"></div>
 <?php } // Show if recordset empty ?> 
	<?php } while ($row_pack001categoria =  mysqli_fetch_assoc($pack001categoria)); ?>
    
</div>
</div>

<div class="tipografiagothicdcha">
<a href="pack001categoria_listades.php">MOSTRAS CATEGORÍAS DESACTIVADAS</a>
</div>
