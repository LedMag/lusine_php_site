...
/*mysql_select_db($database_gabrielle, $gabrielle);
$query_pack001subcategoria = "SELECT * FROM tblpack001subcategoria WHERE strNombre != 'CATÁLOGO COMPLETO' ORDER BY tblpack001subcategoria.intCategoria ASC, tblpack001subcategoria.strPosicion ASC";
...
NO EXISTEN SUBCATEGORÍAS EN ESTE MOMENTO...
 ...
 <?php if ($row_pack001subcategoria['idSubCategoria']!= NULL) { // Show if recordset empty ?> 
<?php do { ?>
 <?php if ($row_pack001subcategoria['strActiva']== "si") { // Show if recordset empty ?>
...
<div class="separadorarlineas"></div>
  <?php } // Show if recordset empty ?>
	<?php } while ($row_pack001subcategoria = mysql_fetch_assoc($pack001subcategoria)); ?>
   <?php } // Show if recordset empty ?>   
...
<div class="tipografiagothicdcha">
<a href="pack001subcategoria_listades.php">MOSTRAS COLECCIONES DESACTIVADOS</a>
</div>
