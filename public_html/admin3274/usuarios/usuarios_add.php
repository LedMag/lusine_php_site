...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO tblusuario (strNombre, strPassword, strLevel, strNameUsuario) VALUES (%s, %s, %s, %s)",
                       GetSQLValueString($_POST['strNombre'], "text"),
                       GetSQLValueString(md5($_POST['strPassword']), "text"),
                       GetSQLValueString($_POST['strLevel'], "text"),
					   GetSQLValueString($_POST['strNamerUsuario'], "text"));
...
<div class="formularios">
  ...
  <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
    <table align="center">
    <tr valign="baseline">
        <td nowrap="nowrap" align="right">Nombre Contacto</td>
        <td><input name="strNameUsuario" type="text" class="a1normal" value="" size="32" /></td>
      </tr>
      ...
      <tr valign="baseline">
        ...
        <td><input name="strPassword" type="password" class="a1normal" value="" size="32" /></td>
      </tr>
      <tr valign="baseline">
        <td nowrap="nowrap" align="right">Level:</td>
        <td><select name="strLevel" class="a1normal">
          ...
          <option value="invitado" <?php if (!(strcmp("invitado", ""))) {echo "SELECTED";} ?>>invitado</option>
        </select></td>
      </tr>
      <tr valign="baseline">
