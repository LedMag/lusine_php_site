...
<a href="usuarios_add.php">Añadir nuevo Usuario</a>
<!-- InstanceEndEditable -->
  </td>
</tr>
<!--**************************************************************************************************** -->
...
<table width="100%" border="0">
  <tr>
    <td width="45%" bgcolor="#8a9a9f">&nbsp;Email</td>
    <td width="20%" bgcolor="#8a9a9f">&nbsp;Password</td>
    <td width="20%" bgcolor="#8a9a9f">&nbsp;Level</td>
    <td width="15%" align="center" bgcolor="#8a9a9f">Acción</td>
  </tr>
  <?php do { ?>
    <tr>
      <td><?php echo $row_usuarios['strNombre']; ?></td>
      <td><?php echo $row_usuarios['strPassword']; ?></td>
      <td><?php echo $row_usuarios['strLevel']; ?></td>
      <td align="center" class="editar"><a href="usuarios_edit.php?recordID=<?php echo $row_usuarios['idUsuario']; ?>">editar</a> - <a href="usuarios_delete.php?recordID=<?php echo $row_usuarios['idUsuario']; ?>">eliminar</a></td>
    </tr>
