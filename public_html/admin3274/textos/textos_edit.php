...
$textos = mysql_query($query_textos, $gabrielle) or die(mysql_error());
$row_textos = mysql_fetch_assoc($textos);
$totalRows_textos = mysql_num_rows($textos);

mysql_select_db($database_gabrielle, $gabrielle);
$query_seo = "SELECT * FROM tblseo ORDER BY tblseo.idSeo DESC";
$seo = mysql_query($query_seo, $gabrielle) or die(mysql_error());
